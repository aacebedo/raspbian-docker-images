...
""")
  ...
  def main(raw_args):
    ...
    try:
      SeafileInstaller.install(args.install_dir, args.archive, args.server_host, args.server_name, args.server_port, args.data_dir)
      SeafileInstaller.generate_nginx_config(args.nginx_dir, args.server_host,args.install_dir)
      SeafileInstaller.generate_seahub_settings(args.install_dir, args.server_host)
      SeafileInstaller.generate_ccnet(args.install_dir, args.server_host)
